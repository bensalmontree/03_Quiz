...
while questions_answered != question_number:
    ...
    if select_difficulty == "easy":
            if user_choice == "true" and answer == "true":
                outcome = "Correct"
                answer_summary.append("Right! ╰(*°▽°*)╯")
                questions_correct += 1
            elif user_choice == "false" and answer == "false":
                outcome = "Correct"
                questions_correct += 1
                answer_summary.append("Right! ╰(*°▽°*)╯")
            else:
        ...
        if user_choice == "true" and gen_question == "correct_question":
            outcome = "Correct"
            answer_summary.append("Right! ╰(*°▽°*)╯")
            questions_correct += 1
        elif user_choice == "false" and gen_question == "incorrect_question":
                outcome = "Correct"
                answer_summary.append("Right! ╰(*°▽°*)╯")
                questions_correct += 1
        else:
    ...
    outcome = "Question {}: {} - You said {}, you got it {}".format(questions_answered, question, user_choice, answer_summary[questions_answered -1])
